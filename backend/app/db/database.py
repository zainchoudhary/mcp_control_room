...
from app.db.models import MCP, ChatSession, Message
from app.services.ghost_mode import GHOST_SESSION_TITLE
...
async def delete_session(db: AsyncSession, session_id: str, user_id: str):
    ...
    session = result.scalar_one_or_none()
    if session:
        from app.services.attachments import clear_session_attachments
